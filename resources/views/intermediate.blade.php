...
@section('content')
    ...
    <a href="{{ url('/intermediate/stage1') }}">
        <img src="{{ asset('asset/map-autumn/autumn1.svg') }}" alt="stage"
            style="position: absolute; top: 510px; left: 100px;">
    </a>

    <a href="{{ url('/intermediate/stage2') }}">
        <img src="{{ asset('asset/map-autumn/autumn2.svg') }}" alt="stage"
            style="position: absolute; top: 430px; left: 430px;">
    </a>

    <a href="{{ url('/intermediate/stage3') }}">
        <img src="{{ asset('asset/map-autumn/autumn3.svg') }}" alt="stage"
            style="position: absolute; top: 500px; left: 700px;">
    </a>

    <a href="{{ url('/intermediate/stage4') }}">
        <img src="{{ asset('asset/map-autumn/autumn4.svg') }}" alt="stage"
            style="position: absolute; bottom: -260px; right: 430px;">
    </a>

    <a href="{{ url('/intermediate/stage5') }}">
        <img src="{{ asset('asset/map-autumn/autumn5.svg') }}" alt="stage"
            style="position: absolute; bottom: -340px; right: 100px;">
    </a>

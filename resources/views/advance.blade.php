...
<body>
  <audio id="bg-audio" loop>
    ...
    <a href="{{ url('/advance/stage1') }}">
      <img src="{{ asset('asset/map-winter/winter5.svg') }}" alt="stage" style="position: absolute; top: 450px; right: 100px;">
    </a>

    <a href="{{ url('/advance/stage2') }}">
      <img src="{{ asset('asset/map-winter/winter4.svg') }}" alt="stage" style="position: absolute; top: 380px; right: 430px;">
    </a>

    <a href="{{ url('/advance/stage3') }}">
      <img src="{{ asset('asset/map-winter/winter3.svg') }}" alt="stage" style="position: absolute; top: 500px; left: 590px;">
    </a>

    <a href="{{ url('/advance/stage4') }}">
      <img src="{{ asset('asset/map-winter/winter2.svg') }}" alt="stage" style="position: absolute; bottom: -260px; left: 430px;">
    </a>

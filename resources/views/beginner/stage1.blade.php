...
<body>
    <div>
        ...
        <div class="question-container">
            <img src="{{ asset('asset/beginner/' . $question->question_detail) }}" alt="Soal" width="600" class="question-img">
